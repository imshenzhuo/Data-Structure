    ...
    while ( (ch = *infixExpression) != '\0') { 
        switch (ch) {
            ...
            case '(':   countBrace++;
                        ...
                        /* proper -> No abnormalities found, push the char */
            ...
            case ')':   countBrace--;
                        ...
                        // proper -> retrieve the char until '(' 
